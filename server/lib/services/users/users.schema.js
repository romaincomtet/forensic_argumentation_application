...
exports.userSchema = typebox_1.Type.Object({
    ...
    isOrganisationUser: typebox_1.Type.Optional(typebox_1.Type.Boolean({ default: false })),
...
exports.userDataSchema = typebox_1.Type.Pick(exports.userSchema, ['email', 'password', 'name', 'isOrganisationUser'], {
    $id: 'UserData'
});
...
exports.userQueryProperties = typebox_1.Type.Pick(exports.userSchema, ['id', 'name', 'isOrganisationUser']);
